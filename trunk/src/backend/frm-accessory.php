...
<div class="panel panel-success">
    <div class="panel-heading clearfix">
        <h4 class="panel-title pull-left" style="padding-top: 7.5px;">
            <i class="glyphicon glyphicon-th-large"></i> อุปกรณ์เสริมที่ติดเครื่องซ่อม
        </h4>
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <form class="form-horizontal" name="frm-accessory" id="frm-accessory">
                ...
                <div class="form-group">
                    <label for="input-nameeng" class="col-sm-2 control-label">อธิบาย</label>
                    <div class="col-sm-6">
    ...
    $(document).ready(function() {
        var valid = $('#frm-accessory').validationEngine('attach', {
            ...
            onValidationComplete: function(form, status) {
                ...
                if (status == true) {
                    post_form('frm-accessory', '../method/accessory.php?method=create');
                }
            }
        });
        valid.css({
